...
@Entity
@Table(name = "riceSales")
public class RiceSales extends BaseEntity<Long> {
	...
	public RiceSales(String memoNo, String companyCode, Date date, String itemName, BigDecimal quantity,
